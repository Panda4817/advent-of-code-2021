...
public class Day24 implements Day {
    ...
    // Hard coded numbers from input that changes
    Long[][] myInputValues = {
            {1L, 13L, 8L},
            {1L, 12L, 13L},
            {1L, 12L, 8L},
    ...
    private long returnB(String b) {
        ...
        if (Arrays.stream(numbers).toList().contains(b.substring(0, 1)) || b.substring(0, 1).equals("-")) {
    ...
    public int part1() {
        ...
        System.out.println(Arrays.stream(modelNumber).toList());
